...
class PickupService : Service() {
    ...
    private val accelListener = object : SensorEventListener {
        override fun onSensorChanged(event: SensorEvent) {
            if (!Prefs.isFacePickupEnabled(this@PickupService) && !Prefs.isAnswerPickupEnabled(this@PickupService)) {
                return
            }
            ...
            if (moved && recentFlat && now - lastAccelTrigger > 3000L) {
    ...
    private fun registerPickupTrigger() {
        if (!Prefs.isFacePickupEnabled(this) && !Prefs.isAnswerPickupEnabled(this)) {
            cancelPickupTrigger()
            return
        }
    ...
    companion object {
        ...
        fun shouldRun(context: Context): Boolean {
            ...
            return faceShortcut || facePickup || answerPickup
        }
