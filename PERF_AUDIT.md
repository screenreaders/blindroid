...
- Notification reader now caches app labels to avoid repeated PackageManager lookups for frequent notifications. `app/src/main/java/com/screenreaders/blindroid/notifications/BlindroidNotificationListener.kt`
