...
- [x] Akcje menu pływającego: Read screen, Scan hub, Item chooser, Live recognition, Voice commands, Clipboard history, Translate text, Describe image, Face recognition, Screen curtain, Quick settings, Read from top, Read from current, Toggle voice feedback, Announce time, Announce battery
