...
public class TalkBackPreferenceFilter {
  ...
  enum TalkBackPreference {
    ...
    NOTIFICATION_LOCKSCREEN(R.string.pref_notification_read_lockscreen_key, HIDDEN_ON_WATCH),
    NOTIFICATION_SUPPRESS_DURING_READING(
        R.string.pref_notification_suppress_during_reading_key, HIDDEN_ON_WATCH),
    // Advanced settings.
    ...
    GESTURE_MACROS_COPY(R.string.pref_macro_copy_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    ...
    QUICK_MENU_IMPORT_APPS(R.string.pref_quick_menu_import_apps_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_EXPORT_APPS_FILE(
        R.string.pref_quick_menu_export_apps_file_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_IMPORT_APPS_FILE(
        R.string.pref_quick_menu_import_apps_file_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    ...
    QUICK_MENU_APPLY_SAVED_CURRENT(
        R.string.pref_quick_menu_apply_saved_current_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_EXPORT_CURRENT(
        R.string.pref_quick_menu_export_current_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_IMPORT_CURRENT(
        R.string.pref_quick_menu_import_current_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_EXPORT_CURRENT_FILE(
        R.string.pref_quick_menu_export_current_file_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_IMPORT_CURRENT_FILE(
        R.string.pref_quick_menu_import_current_file_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    ...
    QUICK_MENU_ENABLE_ALL(R.string.pref_quick_menu_enable_all_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
    QUICK_MENU_DISABLE_ALL(R.string.pref_quick_menu_disable_all_key, HIDDEN_ON_TV | HIDDEN_ON_WATCH),
